...
type TimeServiceClient interface {
	GetTime(ctx context.Context, in *TimeZoneRequest, opts ...grpc.CallOption) (*TimeResponse, error)
}
...
func (c *timeServiceClient) GetTime(ctx context.Context, in *TimeZoneRequest, opts ...grpc.CallOption) (*TimeResponse, error) {
	out := new(TimeResponse)
	err := c.cc.Invoke(ctx, "/WorldTime.TimeService/GetTime", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type TimeServiceServer interface {
	GetTime(context.Context, *TimeZoneRequest) (*TimeResponse, error)
...
func (UnimplementedTimeServiceServer) GetTime(context.Context, *TimeZoneRequest) (*TimeResponse, error) {
...
func _TimeService_GetTime_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/WorldTime.TimeService/GetTime",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TimeServiceServer).GetTime(ctx, req.(*TimeZoneRequest))
	}
...
var TimeService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "WorldTime.TimeService",
	...
	Metadata: "protoc/worldtime.proto",
}
